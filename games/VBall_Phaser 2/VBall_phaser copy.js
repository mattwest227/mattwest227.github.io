...
function preload() {
    this.load.image('ball', '/games/VBall_phaser 2/ball.png');
    this.load.image('player', '/games/VBall_phaser 2/star_88.png');
    this.load.image('background', '/games/VBall_phaser 2/VBackground.png');
};
...
//bump
            ...
            this.physics.add.collider(gameState.player, gameState.ball, function () {
                    /*if (gameState.player === gameState.player4) {
                        gameState.ball.x *= -1}*/
                    gameState.ball.setVelocity(100, -1200);
                    gameState.ball.setAcceleration(200, 200);
...
//set
    this.physics.add.collider(gameState.player, gameState.ball, function () {
        ...
        if(gameState.player4.checkCollision.down === false) {
        gameState.ball.setVelocity(-1200, -1200);
        gameState.ball.setAcceleration(-1200, -200)
        gameState.player = gameState.player3
        }
    })
